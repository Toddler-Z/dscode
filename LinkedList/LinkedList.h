...
T SingleLinkedList<T>::getCurrentVal() const
{
    ...
    {
        std::cout << "Empty current poaition! Can't get value!" << std::endl;
        return T();
    }
    else
    {
...
void SingleLinkedList<T>::setCurrentVal(const T &_val)
{
    if (currentPos == nullptr)
    {
        std::cout << "Empty current poaition! Can't set value!" << std::endl;
        }
    else
    {
...
{   if (currentPos == nullptr)
    ...
    if (currentPos == head && currentPos->next == nullptr)
